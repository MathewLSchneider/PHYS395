...
! compile with: gfortran -O3 -fdefault-real-8 -fopenmp Q3.f90 -lcfitsio
...
dt = 0.01
!write (*,*) -12.0/(cosh(1.0)*cosh(1.0)), V(1.0), E([1.0, 0.0])
traj = integrate(1.0, 20.0, dt)
! phase space scan
!$omp parallel do
do j = 1,ny
do i = 1,nx
...
function integrate(x, t, dt)
	...
	do i = 1,n
		call gl10(u, dt)
		write (*,'(8g24.16)') i*dt, u(1), u(2), E(u)/E0 - 1.0
